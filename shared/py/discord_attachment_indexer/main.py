...
from shared.py.utils.discord_attachment import (
    index_attachments as extract_and_store_attachments,
)
...
def index_attachments_in_db(message: discord.Message) -> None:
...
async def index_channel(channel: discord.TextChannel) -> None:
    ...
    for message in await fetch_channel_history(
        ...
        index_attachments_in_db(message)
