...
export class Parser {
  ...
  private nud(t: Tok): Expr {
    if (t.kind === "num")
      return { kind: "Num", value: Number(t.text), span: t.span } as any;
    if (t.kind === "str")
      return { kind: "Str", value: t.text, span: t.span } as any;
    if (t.kind === "kw" && (t.text === "true" || t.text === "false"))
      return { kind: "Bool", value: t.text === "true", span: t.span } as any;
    if (t.kind === "kw" && t.text === "null")
      return { kind: "Null", span: t.span } as any;
    ...
    // identifier
    if (t.kind === "id")
      return { kind: "Var", name: mkName(t.text, t.span) } as any;
