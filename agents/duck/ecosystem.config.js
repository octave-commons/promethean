...
export default {
  apps: [
    defineApp('duck_discord_indexer', 'uv', ['run', 'python', '-m', 'main'], {
    ...
    //   },
    // }),
    defineApp('duck_attachment_indexer', 'uv', ['run', 'python', '-m', 'main'], {
    ...
    defineApp('duck_attachment_embedder', 'uv', ['run', 'python', '-m', 'main'], {
