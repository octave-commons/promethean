...
title: "duck-web — throttled RTCDataChannel sender with backpressure -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web -web"
slug: "throttled-datachannel-sender"
status: "review"
priority: "P1"
labels: ["duck-web", "webrtc", "perf"]
