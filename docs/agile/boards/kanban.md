...
- [ ] [Run bakeoff (see below)](../tasks/run_bakeoff_see_below_md.md) #rejected
...
- [ ] [Agent Tasks Persistence Migration to DualStore](../tasks/Agent Tasks Persistence Migration to DualStore.md) #breakdown
- [ ] [ChatGPT export injest with dedupe index and hashes](../tasks/ChatGPT export injest with dedupe index and hashes.md) #breakdown
- [ ] [Document-Driven Development for Service Scripts](../tasks/structure_vault_to_mirror_services_agents_docs_md_md.md) #breakdown
- [ ] [LSP server for home brew lisp incoming](../tasks/LSP server for home brew lisp incoming.md) #breakdown
- [ ] [Set up proper openai custom gpt compatable oauth login flow](../tasks/Set up proper openai custom gpt compatable oauth login flow.md) #breakdown
- [ ] [add twitch chat integration md md](../tasks/add_twitch_chat_integration_md_md.md) #breakdown
- [ ] [breakdown Makefile.hy](../tasks/breakdown Makefile.hy.md) #breakdown
- [ ] [database migration system](../tasks/database migration system.md) #breakdown
- [ ] [finish whisper npu system md md](../tasks/finish_whisper_npu_system_md_md.md) #breakdown
- [ ] [full agent mode text chat selectively join channels etc md](../tasks/full_agent_mode_text_chat_selectively_join_channels_etc_md.md) #breakdown
- [ ] [gpt bridge fuzzy lookup should return multiple matches when it is used.](../tasks/gpt bridge fuzzy lookup should return multiple matches when it is used..md) #breakdown
- [ ] [harden precommit hooks](../tasks/harden precommit hooks.md) #breakdown
- [ ] [move discord scraper to ts](../tasks/move discord scraper to ts.md) #breakdown
- [ ] [refactor any python modules not currently for ml stuff discord etc 2 md](../tasks/refactor_any_python_modules_not_currently_for_ml_stuff_discord_etc_2_md.md) #breakdown
- [ ] [script for getting github action workflow states for a branch](../tasks/script for getting github action workflow states for a branch.md) #breakdown
- [ ] [smart task templater md](../tasks/smart_task_templater_md.md) #breakdown
...
- [ ] [Add codex layer to emacs](../tasks/Add codex layer to emacs.md) #todo
- [ ] [Add git commands to gpt bridge](../tasks/Add git commands to gpt bridge.md) #todo
- [ ] [Add semantic overlays for layer1 through layer8](../tasks/add_semantic_overlays_for_layer1_through_layer8_md_md.md) #todo
- [ ] [Add tool calls to codex context](../tasks/Add tool calls to codex context.md) #todo
- [ ] [Curate code from personal repository](../tasks/Curate code from personal repository.md) #todo
- [ ] [Decouple Audio Processing Logic From Discord](../tasks/Decouple Audio Processing Logic From Discord.md) #todo
- [ ] [Detect contradictions in memory](../tasks/detect_contradictions_in_memory_md_md.md) #todo
- [ ] [Ensure openapi specs are automaticly updated when an endpoint is changed](../tasks/Ensure openapi specs are automaticly updated when an endpoint is changed.md) #todo
- [ ] [Evaluate and reward flow satisfaction](../tasks/evaluate_and_reward_flow_satisfaction.md) #todo
- [ ] [Find music that triggered copyright mute on twitch for analysis incoming](../tasks/Find music that triggered copyright mute on twitch for analysis incoming.md) #todo
- [ ] [Finish work on gptbridge agent integration](../tasks/Finish work on gptbridge agent integration.md) #todo
- [ ] [Fully convert js ts projects to pnpm incoming](../tasks/Fully convert js ts projects to pnpm incoming.md) #todo
- [ ] [Gather baseline emotion metrics for Eidolon field](../tasks/gather_baseline_emotion_metrics_for_eidolon_field_1_md.md) #todo
- [ ] [Gather open questions about system direction](../tasks/gather_open_questions_about_system_direction_md_md.md) #todo
- [ ] [Identify ancestral resonance patterns](../tasks/identify_ancestral_resonance_patterns_md_md.md) #todo
- [ ] [Implement transcendence cascade](../tasks/implement_transcendence_cascade_md.md) #todo
- [ ] [Integrate synthesis-agent pass on `unique/` to produce draft docs](../tasks/integrate_synthesis-agent_pass_on_unique_to_produce_draft_docs_1_md.md) #todo
- [ ] [LLM service must accept tool calls](../tasks/LLM service must accept tool calls.md) #todo
- [ ] [LLM service must allow streamed responses](../tasks/LLM service must allow streamed responses.md) #todo
- [ ] [Make the system hashtag aware](../tasks/Make the system hashtag aware.md) #todo
- [ ] [OpenAI compatable api](../tasks/OpenAI compatable api.md) #todo
- [ ] [Phase out proxy in favor of bridge service](../tasks/Phase out proxy in favor of bridge service.md) #todo
- [ ] [Run model bakeoff](../tasks/run_model_bakeoff_md.md) #todo
- [ ] [Set up new user roles and policies for the systems](../tasks/Set up new user roles and policies for the systems.md) #todo
- [ ] [Snapshot prompts specs to repo](../tasks/snapshot_prompts_specs_to_repo.md) #todo
- [ ] [Update Makefile to have commands specific for agents](../tasks/update_makefile_to_have_commands_specific_for_agents_md.md) #todo
- [ ] [[[Finalize `MIGRATION_PLAN.md`]]](../tasks/finalize_migration_plan_md_md_md.md) #todo
- [ ] [add file system to context management system md md](../tasks/add_file_system_to_context_management_system_md_md.md) #todo
- [ ] [allow configuration of hyperparameters through discord context size spectrogram resolution interuption threshold md](../tasks/allow_configuration_of_hyperparameters_through_discord_context_size_spectrogram_resolution_interuption_threshold_md.md) #todo
- [ ] [allow old unnessisary messages to decay from database while retaining index entries ids md md](../tasks/allow_old_unnessisary_messages_to_decay_from_database_while_retaining_index_entries_ids_md_md.md) #todo
- [ ] [audio processing service](../tasks/audio processing service.md) #todo
- [ ] [clearly standardize data models](../tasks/clearly standardize data models.md) #todo
- [ ] [connect bluesky](../tasks/connect bluesky.md) #todo
- [ ] [connect reddit](../tasks/connect reddit.md) #todo
- [ ] [connect wikipedia](../tasks/connect wikipedia.md) #todo
- [ ] [context service](../tasks/context service.md) #todo
- [ ] [convert current services to packages, then redefine the services using config files](../tasks/convert current services to packages, then redefine the services using config files.md) #todo
- [ ] [convert smartgpt bridge to ts](../tasks/convert smartgpt bridge to ts.md) #todo
- [ ] [create a generic markdown helper module](../tasks/create a generic markdown helper module.md) #todo
- [ ] [define codex cli baseg agent md md](../tasks/define_codex_cli_baseg_agent_md_md.md) #todo
- [ ] [describe github branching workflow md](../tasks/describe_github_branching_workflow_md.md) #todo
- [ ] [design circular buffers for inputs with layered states of persistance in memory on disk cold storage so md](../tasks/design_circular_buffers_for_inputs_with_layered_states_of_persistance_in_memory_on_disk_cold_storage_so_md.md) #todo
- [ ] [discord chat link traversal md md](../tasks/discord_chat_link_traversal_md_md.md) #todo
- [ ] [dockerize the system](../tasks/dockerize the system.md) #todo
- [ ] [flatten services](../tasks/flatten services.md) #todo
- [ ] [flatten sibilant src folders](../tasks/flatten sibilant src folders.md) #todo
- [ ] [frontend build tool chain](../tasks/frontend build tool chain.md) #todo
- [ ] [hy - js interop](../tasks/hy - js interop.md) #todo
- [ ] [kanban-processor](../tasks/kanban-processor.md) #todo
- [ ] [lisp ecosystem files](../tasks/lisp ecosystem files.md) #todo
- [ ] [lisp package files](../tasks/lisp package files.md) #todo
- [ ] [reach 100 percent complete test coverage 1 md md](../tasks/reach_100_percent_complete_test_coverage_1_md_md.md) #todo
- [ ] [redefine all existing lambdas with high order functions incoming](../tasks/redefine all existing lambdas with high order functions incoming.md) #todo
- [ ] [refactor speech interuption system to be more inteligent using audio data to decide if interupted md md](../tasks/refactor_speech_interuption_system_to_be_more_inteligent_using_audio_data_to_decide_if_interupted_md_md.md) #todo
- [ ] [setup a second agent md](../tasks/setup_a_second_agent_md.md) #todo
- [ ] [tamper monkey script for using templates defined in the vault](../tasks/tamper monkey script for using templates defined in the vault.md) #todo
- [ ] [task generator system](../tasks/task generator system.md) #todo
- [ ] [thinking model integration md md](../tasks/thinking_model_integration_md_md.md) #todo
- [ ] [twitch discord general auto mod md md](../tasks/twitch_discord_general_auto_mod_md_md.md) #todo

## In Progress

- [ ] [Create broker services that can handle all the same tasks as the gpt bridge](../tasks/Create broker services that can handle all the same tasks as the gpt bridge.md) #in-progress
- [ ] [File explorer](../tasks/File explorer.md) #in-progress
- [ ] [MVP local LLM chat interface with tool calls connected to gpt bridge](../tasks/MVP local LLM chat interface with tool calls connected to gpt bridge.md) #in-progress
- [ ] [Promethean Health Dashboard](../tasks/Promethean Health Dashboard.md) #in-progress
- [ ] [Replace all python properly with hy incoming](../tasks/Replace all python properly with hy incoming.md) #in-progress
- [ ] [Update cephalon to use custom embedding function](../tasks/update_cephalon_to_use_custom_embedding_function_md_md.md) #in-progress
- [ ] [Webcrawler](../tasks/Webcrawler.md) #in-progress
- [ ] [breakdown cephalon voice commands file using ecs](../tasks/breakdown cephalon voice commands file using ecs.md) #in-progress
- [ ] [discord image awareness md md](../tasks/discord_image_awareness_md_md.md) #in-progress
- [ ] [identify and resolve a service client apparently connecting repeatedly to broker with new session ids](../tasks/identify_and_resolve_a_service_client_apparently_connecting_repeatedly_to_broker_with_new_session_ids.md) #in-progress
- [ ] [implement classes in compiler lisp incoming](../tasks/implement classes in compiler lisp incoming.md) #in-progress
- [ ] [implement defun in compiler lisp incoming](../tasks/implement defun in compiler lisp incoming.md) #in-progress
- [ ] [periodicly the embedding service will get disconnected from the broker and not die, blocking other processes who require embeddings. incoming](../tasks/periodicly the embedding service will get disconnected from the broker and not die, blocking other processes who require embeddings. incoming.md) #in-progress
- [ ] [pin versions in configs md](../tasks/pin_versions_in_configs_md.md) #in-progress
- [ ] [seperate discord commands from the actions they perform](../tasks/seperate discord commands from the actions they perform.md) #in-progress
- [ ] [set up data migration pipeline and clearly describe conventions](../tasks/set up data migration pipeline and clearly describe conventions.md) #in-progress
- [ ] [setup new service generator](../tasks/setup new service generator.md) #in-progress
- [ ] [setup services to recieve work from the broker via push md](../tasks/setup_services_to_recieve_work_from_the_broker_via_push_md.md) #in-progress
- [ ] [twitch stream title generator md md](../tasks/twitch_stream_title_generator_md_md.md) #in-progress

## In Review

- [ ] [Mock broker](../tasks/Mock broker.md) #in-review
- [ ] [broker gpt bridge parity plan](../tasks/broker gpt bridge parity plan.md) #in-review
