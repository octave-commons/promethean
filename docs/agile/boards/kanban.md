...
- [ ] [[evaluate_and_reward_flow_satisfaction.md|Evaluate and reward flow satisfaction]] #framework-core #ice-box
...
- [ ] [[snapshot_prompts_specs_to_repo.md|Snapshot prompts specs to repo]] #ice-box
...
- [ ] [[start_eidolon.md|Start Eidolon]] #done #framework-core
