...
- [ ] [[Docops pipeline|Integrate synthesis-agent pass on `unique/` to produce draft docs]] #todo
...
- [ ] [[Docops pipeline|Docops pipeline works]] #framework-core #IceBox #ready
