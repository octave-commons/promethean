...
- [ ] [[Web frontend for system management.md|Web frontend for system management]] #accepted
...
- [ ] [[../Tasks/Add file watcher that looks at agent thinking and prompt refinement and runs an LLM on it a few times and asked if it feels like it's ready|Add file watcher that looks at agent thinking and prompt refinement and runs an LLM on it a few times and asked if it feels like it's ready]] #accepted
...
- [ ] [[Add file system to context management system.md|Add file system to context management system]] #todo
- [ ] [[add_snapshot_consumer_to_warm_cache_on_boot.md|Add snapshot consumer to warm cache on boot]] #todo
- [ ] [[Add twitch chat integration.md|Add twitch chat integration]] #todo
...
- [ ] [[Define codex CLI baseg agent.md|Define codex CLI baseg agent]] #todo
...
- [ ] [[Discord chat link traversal.md|Discord chat link traversal]] #todo
...
- [ ] [[Look into why the state object never seems to get updated..md|Look into why the state object never seems to get updated.]] #todo
...
- [ ] [[Send waveforms, spectrograms, and dekstop screenshots to discord for remote storage.md|Send waveforms, spectrograms, and dekstop screenshots to discord for remote storage]] #todo
...
- [ ] [[Thinking Model integration.md|Thinking Model integration]] #todo
- [ ] [[Tool chain management system.md|Tool chain management system]] #todo
- [ ] [[Twitch stream title generator.md|Twitch stream title generator]] #todo
...
- [ ] [[cache decay mechanisim.md|cache decay mechanisim]] #todo
...
- [ ] [[each service registers a pid with a heartbeat service. If they do not successfully check in, terminate the process using the pid.md|each service registers a pid with a heartbeat service. If they do not successfully check in, terminate the process using the pid]] #todo
...
- [ ] [[setup services to recieve work from the broker via push.md|setup services to recieve work from the broker via push]] #todo
- [ ] [[twitch discord general auto mod.md|twitch discord general auto mod]] #todo
