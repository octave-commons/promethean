...
- [ ] [[Build data structures for Eidolon field.md]] #ice-box
...
- [ ] [Create vault-config .obsidian with Kanban and minimal vault setup 1.md] #incoming
...
- [ ] [Write vault-config README.md for Obsidian vault onboarding.md] #rejected
...
- [ ] [[finish whisper NPU system.md]] #accepted
- [ ] [[twitch discord general auto mod.md]] #accepted
...
- [ ] [[Determine PM2 configuration for agents.md]] #breakdown
...
- [ ] [[Decouple from Ollama.md|Add Ollama formally to pipeline]] #ready
- [ ] [[Add semantic overlays for layer1 through layer8.md]] #ready
