...
[Click to try out](https://handlebarsjs.com/examples/literal-segments.html)
...
### Prevent HTML-escaping of helper return values [​](#prevent-html-escaping-of-helper-return-values)
...
### Helpers with Multiple Parameters [​](#helpers-with-multiple-parameters)
...
[Click to try out](https://handlebarsjs.com/examples/helper-multiple-parameters.html)
...
[Click to try out](https://handlebarsjs.com/examples/helper-dynamic-parameters.html)
...
[Click to try out](https://handlebarsjs.com/examples/helper-literals.html)
...
### Helpers with Hash arguments [​](#helpers-with-hash-arguments)
...
[Click to try out](https://handlebarsjs.com/examples/helper-hash-arguments.html)
...
### Disambiguating helpers calls and property lookup [​](#disambiguating-helpers-calls-and-property-lookup)
...
[Click to try out](https://handlebarsjs.com/examples/helper-data-name-conflict.html)
...
Raw blocks operate in the same manner as other [block helpers](https://handlebarsjs.com/guide/block-helpers.html) with the distinction of the child content is treated as a literal string.