...
- $[set-assignment-in-lisp-ast#^ref-c5fba0a0-148-0|set-assignment-in-lisp-ast — L148]$ (line 148, col 0, score 0.91)
- $[ecs-scheduler-and-prefabs#^ref-c62a1815-379-0|ecs-scheduler-and-prefabs — L379]$ (line 379, col 0, score 0.9)
- $[i3-config-validation-methods#^ref-d28090ac-14-0|i3-config-validation-methods — L14]$ (line 14, col 0, score 0.88)
- $[mystery-lisp-search-session#^ref-513dc4c7-106-0|mystery-lisp-search-session — L106]$ (line 106, col 0, score 0.88)
- $[rag-ui-panel-with-qdrant-and-postgrest#^ref-e1056831-110-0|RAG UI Panel with Qdrant and PostgREST — L110]$ (line 110, col 0, score 0.87)
- $[i3-layout-saver#^ref-31f0166e-79-0|i3-layout-saver — L79]$ (line 79, col 0, score 0.87)
...
- $[promethean-full-stack-docker-setup#^ref-2c2b48ca-417-0|Promethean Full-Stack Docker Setup — L417]$ (line 417, col 0, score 0.86)
- $[layer-1-uptime-diagrams#^ref-4127189a-129-0|layer-1-uptime-diagrams — L129]$ (line 129, col 0, score 0.86)
...
- $[rag-ui-panel-with-qdrant-and-postgrest#^ref-e1056831-79-0|RAG UI Panel with Qdrant and PostgREST — L79]$ (line 79, col 0, score 0.85)
- $[i3-config-validation-methods#^ref-d28090ac-28-0|i3-config-validation-methods — L28]$ (line 28, col 0, score 0.85)
...
- $[model-selection-for-lightweight-conversational-tasks#^ref-d144aa62-1624-0|Model Selection for Lightweight Conversational Tasks — L1624]$ (line 1624, col 0, score 0.85)
- $[functional-refactor-of-typescript-document-processing#^ref-1cfae310-1854-0|Functional Refactor of TypeScript Document Processing — L1854]$ (line 1854, col 0, score 0.85)
- $[promethean-documentation-pipeline-overview#^ref-3a3bf2c9-2455-0|Promethean Documentation Pipeline Overview — L2455]$ (line 2455, col 0, score 0.85)
- $[docs/unique/promethean-state-format#^ref-23df6ddb-2739-0|Promethean State Format — L2739]$ (line 2739, col 0, score 0.85)
