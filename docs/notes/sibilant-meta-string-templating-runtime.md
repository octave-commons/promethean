...
## Sources
- $[sibilant-metacompiler-overview#L5|sibilant-metacompiler-overview — L5]$ (line 5, col 1, score 0.87)
- $[docs/unique/template-based-compilation#L90|template-based-compilation — L90]$ (line 90, col 1, score 0.86)
- $[sibilant-meta-prompt-dsl#L137|Sibilant Meta-Prompt DSL — L137]$ (line 137, col 1, score 0.86)
...
- $[unique-info-dump-index#L178|Unique Info Dump Index — L178]$ (line 178, col 1, score 0.99)
- $[unique-info-dump-index#L178|Unique Info Dump Index — L178]$ (line 178, col 3, score 0.99)
...
- $[docs/unique/template-based-compilation#L130|template-based-compilation — L130]$ (line 130, col 1, score 0.98)
- $[docs/unique/template-based-compilation#L130|template-based-compilation — L130]$ (line 130, col 3, score 0.98)
