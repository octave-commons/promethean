...
- $[docs/unique/universal-lisp-interface#^ref-b01856b4-187-0|Universal Lisp Interface — L187]$ (line 187, col 0, score 0.99)
- $[pipeline-enhancements#^ref-e2135d9f-177-0|Pipeline Enhancements — L177]$ (line 177, col 0, score 0.95)
- $[docs/unique/synchronicity-waves-and-web#^ref-91295f3a-3577-0|Synchronicity Waves and Web — L3577]$ (line 3577, col 0, score 0.95)
- $[post-linguistic-transhuman-design-frameworks#^ref-6bcff92c-272-0|Post-Linguistic Transhuman Design Frameworks — L272]$ (line 272, col 0, score 0.95)
- $[promethean-eidolon-synchronicity-model#^ref-2d6e5553-243-0|Promethean_Eidolon_Synchronicity_Model — L243]$ (line 243, col 0, score 0.95)
- $[unique-info-dump-index#^ref-30ec3ba6-219-0|Unique Info Dump Index — L219]$ (line 219, col 0, score 0.95)
- $[promethean-web-ui-setup#^ref-bc5172ca-442-0|prom ui bootstrap — L442]$ (line 442, col 0, score 0.92)
- $[the-jar-of-echoes#^ref-18138627-9580-0|The Jar of Echoes — L9580]$ (line 9580, col 0, score 0.9)
- $[i3-bluetooth-setup#^ref-5e408692-1848-0|i3-bluetooth-setup — L1848]$ (line 1848, col 0, score 0.9)
- [NPU Voice Code and Sensory Integration — L1059]$npu-voice-code-and-sensory-integration.md#^ref-5a02283e-1059-0$ (line 1059, col 0, score 0.9)
- $[obsidian-templating-plugins-integration-guide#^ref-b39dc9d4-2730-0|Obsidian Templating Plugins Integration Guide — L2730]$ (line 2730, col 0, score 0.9)
- $[promethean-dev-workflow-update#^ref-03a5578f-11673-0|Promethean Dev Workflow Update — L11673]$ (line 11673, col 0, score 0.9)
- $[docs/unique/promethean-state-format#^ref-23df6ddb-1449-0|Promethean State Format — L1449]$ (line 1449, col 0, score 0.9)
- $[prompt-folder-bootstrap#^ref-bd4f0976-3180-0|Prompt_Folder_Bootstrap — L3180]$ (line 3180, col 0, score 0.9)
- $Protocol_0_The_Contradiction_Engine — L1555$$protocol-0-the-contradiction-engine.md#^ref-9a93a756-1555-0$ (line 1555, col 0, score 0.9)
- $[docs/unique/interop-and-source-maps#^ref-cdfac40c-497-0|Interop and Source Maps — L497]$ (line 497, col 0, score 0.89)
- [NPU Voice Code and Sensory Integration — L92]$npu-voice-code-and-sensory-integration.md#^ref-5a02283e-92-0$ (line 92, col 0, score 0.89)
- $[obsidian-chatgpt-plugin-integration-guide#^ref-1d3d6c3a-66-0|Obsidian ChatGPT Plugin Integration Guide — L66]$ (line 66, col 0, score 0.89)
- $[obsidian-chatgpt-plugin-integration#^ref-ca8e1399-36-0|Obsidian ChatGPT Plugin Integration — L36]$ (line 36, col 0, score 0.89)
- $[docs/unique/obsidian-ignore-node-modules-regex#^ref-ffb9b2a9-103-0|obsidian-ignore-node-modules-regex — L103]$ (line 103, col 0, score 0.89)
- $[obsidian-templating-plugins-integration-guide#^ref-b39dc9d4-127-0|Obsidian Templating Plugins Integration Guide — L127]$ (line 127, col 0, score 0.89)
- $[openapi-validation-report#^ref-5c152b08-51-0|OpenAPI Validation Report — L51]$ (line 51, col 0, score 0.89)
- $[post-linguistic-transhuman-design-frameworks#^ref-6bcff92c-124-0|Post-Linguistic Transhuman Design Frameworks — L124]$ (line 124, col 0, score 0.89)
- $[promethean-chat-activity-report#^ref-18344cf9-56-0|Promethean Chat Activity Report — L56]$ (line 56, col 0, score 0.89)
- $[observability-infrastructure-setup#^ref-b4e64f8c-348-0|observability-infrastructure-setup — L348]$ (line 348, col 0, score 0.88)
- $[promethean-system-diagrams#^ref-b51e19b4-169-0|promethean-system-diagrams — L169]$ (line 169, col 0, score 0.88)
- $[event-bus-projections-architecture#^ref-cf6b9b17-111-0|Event Bus Projections Architecture — L111]$ (line 111, col 0, score 0.88)
- $[local-only-llm-workflow#^ref-9a8ab57e-129-0|Local-Only-LLM-Workflow — L129]$ (line 129, col 0, score 0.87)
- $[prom-lib-rate-limiters-and-replay-api#^ref-aee4718b-307-0|prom-lib-rate-limiters-and-replay-api — L307]$ (line 307, col 0, score 0.87)
- $[mongo-outbox-implementation#^ref-9c1acd1e-610-0|Mongo Outbox Implementation — L610]$ (line 610, col 0, score 0.87)
- $[docs/unique/event-bus-mvp#^ref-534fe91d-524-0|Event Bus MVP — L524]$ (line 524, col 0, score 0.87)
- [Promethean Event Bus MVP v0.1 — L972]$promethean-event-bus-mvp-v0-1.md#^ref-fe7193a2-972-0$ (line 972, col 0, score 0.87)
- $[eidolonfield#^ref-49d1e1e5-207-0|EidolonField — L207]$ (line 207, col 0, score 0.86)
- $[websocket-gateway-implementation#^ref-e811123d-631-0|WebSocket Gateway Implementation — L631]$ (line 631, col 0, score 0.86)
...
- $[promethean-native-config-design#^ref-ab748541-305-0|Promethean-native config design — L305]$ (line 305, col 0, score 0.86)
- $[board-walk-2025-08-11#^ref-7aa1eb92-127-0|Board Walk – 2025-08-11 — L127]$ (line 127, col 0, score 0.85)
- $lisp-dsl-for-window-management — L124$$lisp-dsl-for-window-management.md#^ref-c5c5ff1c-124-0$ (line 124, col 0, score 0.85)
- $[polymorphic-meta-programming-engine#^ref-7bed0b9a-190-0|polymorphic-meta-programming-engine — L190]$ (line 190, col 0, score 0.85)
- [Promethean Event Bus MVP v0.1 — L973]$promethean-event-bus-mvp-v0-1.md#^ref-fe7193a2-973-0$ (line 973, col 0, score 0.85)
...
- $[pure-node-crawl-stack-with-playwright-and-crawlee#^ref-d527c05d-401-0|Pure-Node Crawl Stack with Playwright and Crawlee — L401]$ (line 401, col 0, score 0.85)
- $[recursive-prompt-construction-engine#^ref-babdb9eb-147-0|Recursive Prompt Construction Engine — L147]$ (line 147, col 0, score 0.85)
- $[markdown-to-org-transpiler#^ref-ab54cdd8-272-0|markdown-to-org-transpiler — L272]$ (line 272, col 0, score 0.85)
...
- $Canonical Org-Babel Matplotlib Animation Template — L747$$canonical-org-babel-matplotlib-animation-template.md#^ref-1b1338fc-747-0$ (line 747, col 0, score 0.85)
- $[creative-moments#^ref-10d98225-400-0|Creative Moments — L400]$ (line 400, col 0, score 0.85)
- $[ducks-attractor-states#^ref-13951643-975-0|Duck's Attractor States — L975]$ (line 975, col 0, score 0.85)
- $[docs/unique/eidolon-field-math-foundations#^ref-008f2ac0-1924-0|eidolon-field-math-foundations — L1924]$ (line 1924, col 0, score 0.85)
- $[functional-refactor-of-typescript-document-processing#^ref-1cfae310-609-0|Functional Refactor of TypeScript Document Processing — L609]$ (line 609, col 0, score 0.85)
- $[promethean-documentation-update.txt#^ref-0b872af2-331-0|Promethean Documentation Update — L331]$ (line 331, col 0, score 0.85)
- $Canonical Org-Babel Matplotlib Animation Template — L735$$canonical-org-babel-matplotlib-animation-template.md#^ref-1b1338fc-735-0$ (line 735, col 0, score 0.85)
- $[creative-moments#^ref-10d98225-407-0|Creative Moments — L407]$ (line 407, col 0, score 0.85)
$$
=======
$$
- $[local-only-llm-workflow]$
