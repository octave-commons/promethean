...
## Sources
- $[migrate-to-provider-tenant-architecture#L111|Migrate to Provider-Tenant Architecture — L111]$ (line 111, col 1, score 0.94)
- $[migrate-to-provider-tenant-architecture#L111|Migrate to Provider-Tenant Architecture — L111]$ (line 111, col 3, score 0.94)
- $[migrate-to-provider-tenant-architecture#L40|Migrate to Provider-Tenant Architecture — L40]$ (line 40, col 4, score 0.92)
- $[migrate-to-provider-tenant-architecture#L40|Migrate to Provider-Tenant Architecture — L40]$ (line 40, col 6, score 0.92)
- $[sibilant-meta-prompt-dsl#L158|Sibilant Meta-Prompt DSL — L158]$ (line 158, col 1, score 0.86)
- $[sibilant-meta-prompt-dsl#L158|Sibilant Meta-Prompt DSL — L158]$ (line 158, col 3, score 0.86)
- $[promethean-native-config-design#L31|Promethean-native config design — L31]$ (line 31, col 1, score 0.95)
- $[promethean-native-config-design#L31|Promethean-native config design — L31]$ (line 31, col 3, score 0.95)
- $[dynamic-context-model-for-web-components#L331|Dynamic Context Model for Web Components — L331]$ (line 331, col 1, score 0.95)
- $[dynamic-context-model-for-web-components#L331|Dynamic Context Model for Web Components — L331]$ (line 331, col 3, score 0.95)
- $[promethean-native-config-design#L32|Promethean-native config design — L32]$ (line 32, col 1, score 0.93)
- $[promethean-native-config-design#L32|Promethean-native config design — L32]$ (line 32, col 3, score 0.93)
- $[promethean-native-config-design#L33|Promethean-native config design — L33]$ (line 33, col 1, score 0.93)
- $[promethean-native-config-design#L33|Promethean-native config design — L33]$ (line 33, col 3, score 0.93)
- $[prom-lib-rate-limiters-and-replay-api#L333|prom-lib-rate-limiters-and-replay-api — L333]$ (line 333, col 3, score 0.95)
- $[prom-lib-rate-limiters-and-replay-api#L333|prom-lib-rate-limiters-and-replay-api — L333]$ (line 333, col 5, score 0.95)
- $[prompt-folder-bootstrap#L24|Prompt_Folder_Bootstrap — L24]$ (line 24, col 1, score 0.88)
- $[prompt-folder-bootstrap#L42|Prompt_Folder_Bootstrap — L42]$ (line 42, col 1, score 0.88)
- $[prompt-folder-bootstrap#L66|Prompt_Folder_Bootstrap — L66]$ (line 66, col 1, score 0.88)
- $[prompt-folder-bootstrap#L84|Prompt_Folder_Bootstrap — L84]$ (line 84, col 1, score 0.88)
- $[prompt-folder-bootstrap#L103|Prompt_Folder_Bootstrap — L103]$ (line 103, col 1, score 0.88)
- $[prompt-folder-bootstrap#L130|Prompt_Folder_Bootstrap — L130]$ (line 130, col 1, score 0.88)
- $[prompt-folder-bootstrap#L152|Prompt_Folder_Bootstrap — L152]$ (line 152, col 1, score 0.88)
- $[ecs-scheduler-and-prefabs#L338|ecs-scheduler-and-prefabs — L338]$ (line 338, col 1, score 0.88)
...
- $[agent-reflections-and-prompt-evolution#L138|Agent Reflections and Prompt Evolution — L138]$ (line 138, col 1, score 1)
- $[agent-reflections-and-prompt-evolution#L138|Agent Reflections and Prompt Evolution — L138]$ (line 138, col 3, score 1)
...
- $[voice-access-layer-design#L331|Voice Access Layer Design — L331]$ (line 331, col 1, score 1)
- $[voice-access-layer-design#L331|Voice Access Layer Design — L331]$ (line 331, col 3, score 1)
...
- $[migrate-to-provider-tenant-architecture#L299|Migrate to Provider-Tenant Architecture — L299]$ (line 299, col 1, score 1)
- $[migrate-to-provider-tenant-architecture#L299|Migrate to Provider-Tenant Architecture — L299]$ (line 299, col 3, score 1)
- $[migrate-to-provider-tenant-architecture#L300|Migrate to Provider-Tenant Architecture — L300]$ (line 300, col 1, score 0.99)
- $[migrate-to-provider-tenant-architecture#L300|Migrate to Provider-Tenant Architecture — L300]$ (line 300, col 3, score 0.99)
...
- $[sibilant-meta-prompt-dsl#L205|Sibilant Meta-Prompt DSL — L205]$ (line 205, col 1, score 1)
- $[sibilant-meta-prompt-dsl#L205|Sibilant Meta-Prompt DSL — L205]$ (line 205, col 3, score 1)
...
- $[sibilant-meta-prompt-dsl#L206|Sibilant Meta-Prompt DSL — L206]$ (line 206, col 1, score 1)
- $[sibilant-meta-prompt-dsl#L206|Sibilant Meta-Prompt DSL — L206]$ (line 206, col 3, score 1)
...
- $[sibilant-meta-prompt-dsl#L207|Sibilant Meta-Prompt DSL — L207]$ (line 207, col 1, score 1)
- $[sibilant-meta-prompt-dsl#L207|Sibilant Meta-Prompt DSL — L207]$ (line 207, col 3, score 1)
- $[sibilant-meta-prompt-dsl#L208|Sibilant Meta-Prompt DSL — L208]$ (line 208, col 1, score 1)
- $[sibilant-meta-prompt-dsl#L208|Sibilant Meta-Prompt DSL — L208]$ (line 208, col 3, score 1)
- $[promethean-agent-config-dsl#L326|Promethean Agent Config DSL — L326]$ (line 326, col 1, score 0.99)
- $[promethean-agent-config-dsl#L326|Promethean Agent Config DSL — L326]$ (line 326, col 3, score 0.99)
...
- $[docs/unique/event-bus-mvp#L558|Event Bus MVP — L558]$ (line 558, col 1, score 0.98)
- $[docs/unique/event-bus-mvp#L558|Event Bus MVP — L558]$ (line 558, col 3, score 0.98)
- $[ecs-scheduler-and-prefabs#L410|ecs-scheduler-and-prefabs — L410]$ (line 410, col 1, score 0.99)
- $[ecs-scheduler-and-prefabs#L410|ecs-scheduler-and-prefabs — L410]$ (line 410, col 3, score 0.99)
...
- $[ecs-scheduler-and-prefabs#L413|ecs-scheduler-and-prefabs — L413]$ (line 413, col 1, score 0.98)
- $[ecs-scheduler-and-prefabs#L413|ecs-scheduler-and-prefabs — L413]$ (line 413, col 3, score 0.98)
- $[ecs-scheduler-and-prefabs#L411|ecs-scheduler-and-prefabs — L411]$ (line 411, col 1, score 0.99)
- $[ecs-scheduler-and-prefabs#L411|ecs-scheduler-and-prefabs — L411]$ (line 411, col 3, score 0.99)
...
- $[ecs-scheduler-and-prefabs#L412|ecs-scheduler-and-prefabs — L412]$ (line 412, col 1, score 0.99)
- $[ecs-scheduler-and-prefabs#L412|ecs-scheduler-and-prefabs — L412]$ (line 412, col 3, score 0.99)
...
- $[ecs-scheduler-and-prefabs#L414|ecs-scheduler-and-prefabs — L414]$ (line 414, col 1, score 0.99)
- $[ecs-scheduler-and-prefabs#L414|ecs-scheduler-and-prefabs — L414]$ (line 414, col 3, score 0.99)
...
- $[agent-reflections-and-prompt-evolution#L141|Agent Reflections and Prompt Evolution — L141]$ (line 141, col 1, score 0.99)
- $[agent-reflections-and-prompt-evolution#L141|Agent Reflections and Prompt Evolution — L141]$ (line 141, col 3, score 0.99)
- $[ecs-scheduler-and-prefabs#L415|ecs-scheduler-and-prefabs — L415]$ (line 415, col 1, score 0.99)
- $[ecs-scheduler-and-prefabs#L415|ecs-scheduler-and-prefabs — L415]$ (line 415, col 3, score 0.99)
...
- $[ecs-scheduler-and-prefabs#L416|ecs-scheduler-and-prefabs — L416]$ (line 416, col 1, score 0.99)
- $[ecs-scheduler-and-prefabs#L416|ecs-scheduler-and-prefabs — L416]$ (line 416, col 3, score 0.99)
...
- $[prompt-folder-bootstrap#L193|Prompt_Folder_Bootstrap — L193]$ (line 193, col 1, score 0.99)
- $[prompt-folder-bootstrap#L193|Prompt_Folder_Bootstrap — L193]$ (line 193, col 3, score 0.99)
...
- $[docs/unique/eidolon-field-math-foundations#L154|eidolon-field-math-foundations — L154]$ (line 154, col 1, score 0.98)
- $[docs/unique/eidolon-field-math-foundations#L154|eidolon-field-math-foundations — L154]$ (line 154, col 3, score 0.98)
- $[promethean-infrastructure-setup#L609|Promethean Infrastructure Setup — L609]$ (line 609, col 1, score 0.98)
- $[promethean-infrastructure-setup#L609|Promethean Infrastructure Setup — L609]$ (line 609, col 3, score 0.98)
