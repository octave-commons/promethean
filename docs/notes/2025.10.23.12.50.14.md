...
- [ ] 90% tests coverage on the original implementations is reached before any other work is done
- [ ] Integration tests exist for dependent packages and pass.
- [ ] There exists a pure functional interface meeting the following criteria:
