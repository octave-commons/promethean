---
$$
uuid: 72902884-553b-456f-a2ac-3e92d0b85f5f
$$
...
1. **Pure-Lua “AI-ish”** ^ref-a4d90289-5-0 ^ref-672da53b-5-0
...
2. **External agent via RCON (recommended)** ^ref-a4d90289-8-0 ^ref-672da53b-8-0
...
- $[graph-ds#^ref-6620e2f2-372-0|graph-ds — L372]$ (line 372, col 0, score 1)
- $[polyglot-repl-interface-layer#^ref-9c79206d-238-0|polyglot-repl-interface-layer — L238]$ (line 238, col 0, score 1)
- $[promethean-chat-activity-report#^ref-18344cf9-101-0|Promethean Chat Activity Report — L101]$ (line 101, col 0, score 1)
- $[promethean-copilot-intent-engine#^ref-ae24a280-139-0|Promethean-Copilot-Intent-Engine — L139]$ (line 139, col 0, score 1)
- $[promethean-data-sync-protocol#^ref-9fab9e76-66-0|Promethean Data Sync Protocol — L66]$ (line 66, col 0, score 1)
- $[promethean-dev-workflow-update#^ref-03a5578f-144-0|Promethean Dev Workflow Update — L144]$ (line 144, col 0, score 1)
- $[promethean-documentation-overview#^ref-9413237f-48-0|Promethean Documentation Overview — L48]$ (line 48, col 0, score 1)
- $[promethean-documentation-pipeline-overview#^ref-3a3bf2c9-223-0|Promethean Documentation Pipeline Overview — L223]$ (line 223, col 0, score 1)
- $[promethean-documentation-update#^ref-c0392040-41-0|Promethean Documentation Update — L41]$ (line 41, col 0, score 1)
