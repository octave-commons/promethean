...
## Sources
- $[docs/unique/template-based-compilation#L1|template-based-compilation — L1]$ (line 1, col 1, score 0.88)
- $[lisp-compiler-integration#L9|Lisp-Compiler-Integration — L9]$ (line 9, col 1, score 0.87)
- $[set-assignment-in-lisp-ast#L5|set-assignment-in-lisp-ast — L5]$ (line 5, col 1, score 0.89)
- $[docs/unique/interop-and-source-maps#L319|Interop and Source Maps — L319]$ (line 319, col 1, score 0.98)
- $[set-assignment-in-lisp-ast#L58|set-assignment-in-lisp-ast — L58]$ (line 58, col 1, score 0.96)
...
- $[unique-info-dump-index#L100|Unique Info Dump Index — L100]$ (line 100, col 1, score 1)
- $[unique-info-dump-index#L100|Unique Info Dump Index — L100]$ (line 100, col 3, score 1)
...
- $[polyglot-repl-interface-layer#L167|polyglot-repl-interface-layer — L167]$ (line 167, col 1, score 0.98)
- $[polyglot-repl-interface-layer#L167|polyglot-repl-interface-layer — L167]$ (line 167, col 3, score 0.98)
- $[cross-language-runtime-polymorphism#L217|Cross-Language Runtime Polymorphism — L217]$ (line 217, col 1, score 0.98)
- $[cross-language-runtime-polymorphism#L217|Cross-Language Runtime Polymorphism — L217]$ (line 217, col 3, score 0.98)
- $[cross-target-macro-system-in-sibilant#L190|Cross-Target Macro System in Sibilant — L190]$ (line 190, col 1, score 0.98)
- $[cross-target-macro-system-in-sibilant#L190|Cross-Target Macro System in Sibilant — L190]$ (line 190, col 3, score 0.98)
- $[sibilant-metacompiler-overview#L103|sibilant-metacompiler-overview — L103]$ (line 103, col 1, score 0.98)
- $[sibilant-metacompiler-overview#L103|sibilant-metacompiler-overview — L103]$ (line 103, col 3, score 0.98)
- $[lispy-macros-with-syntax-rules#L416|Lispy Macros with syntax-rules — L416]$ (line 416, col 1, score 0.99)
- $[lispy-macros-with-syntax-rules#L416|Lispy Macros with syntax-rules — L416]$ (line 416, col 3, score 0.99)
...
- $[lispy-macros-with-syntax-rules#L417|Lispy Macros with syntax-rules — L417]$ (line 417, col 1, score 0.98)
- $[lispy-macros-with-syntax-rules#L417|Lispy Macros with syntax-rules — L417]$ (line 417, col 3, score 0.98)
- $[lispy-macros-with-syntax-rules#L409|Lispy Macros with syntax-rules — L409]$ (line 409, col 1, score 0.98)
- $[lispy-macros-with-syntax-rules#L409|Lispy Macros with syntax-rules — L409]$ (line 409, col 3, score 0.98)
...
- $[docs/unique/interop-and-source-maps#L529|Interop and Source Maps — L529]$ (line 529, col 1, score 0.98)
- $[docs/unique/interop-and-source-maps#L529|Interop and Source Maps — L529]$ (line 529, col 3, score 0.98)
- $[js-to-lisp-reverse-compiler#L427|js-to-lisp-reverse-compiler — L427]$ (line 427, col 1, score 0.97)
- $[js-to-lisp-reverse-compiler#L427|js-to-lisp-reverse-compiler — L427]$ (line 427, col 3, score 0.97)
