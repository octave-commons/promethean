...
## Sources
- $[docs/unique/universal-lisp-interface#L1|Universal Lisp Interface — L1]$ (line 1, col 1, score 0.91)
- $[polyglot-repl-interface-layer#L114|polyglot-repl-interface-layer — L114]$ (line 114, col 1, score 0.85)
- $[polyglot-repl-interface-layer#L56|polyglot-repl-interface-layer — L56]$ (line 56, col 1, score 0.9)
- $[sibilant-macro-targets#L133|sibilant-macro-targets — L133]$ (line 133, col 1, score 0.87)
- $[docs/unique/template-based-compilation#L90|template-based-compilation — L90]$ (line 90, col 1, score 0.9)
- $[polyglot-repl-interface-layer#L146|polyglot-repl-interface-layer — L146]$ (line 146, col 1, score 0.9)
- $[cross-target-macro-system-in-sibilant#L160|Cross-Target Macro System in Sibilant — L160]$ (line 160, col 1, score 0.88)
- $[cross-language-runtime-polymorphism#L193|Cross-Language Runtime Polymorphism — L193]$ (line 193, col 1, score 0.88)
- $[sibilant-metacompiler-overview#L74|sibilant-metacompiler-overview — L74]$ (line 74, col 1, score 0.87)
- $[sibilant-macro-targets#L153|sibilant-macro-targets — L153]$ (line 153, col 1, score 0.87)
...
- $[voice-access-layer-design#L328|Voice Access Layer Design — L328]$ (line 328, col 1, score 0.98)
- $[voice-access-layer-design#L328|Voice Access Layer Design — L328]$ (line 328, col 3, score 0.98)
- $[voice-access-layer-design#L329|Voice Access Layer Design — L329]$ (line 329, col 1, score 0.96)
- $[voice-access-layer-design#L329|Voice Access Layer Design — L329]$ (line 329, col 3, score 0.96)
- $[sibilant-meta-prompt-dsl#L219|Sibilant Meta-Prompt DSL — L219]$ (line 219, col 1, score 0.97)
- $[sibilant-meta-prompt-dsl#L219|Sibilant Meta-Prompt DSL — L219]$ (line 219, col 3, score 0.97)
- $[docs/unique/template-based-compilation#L134|template-based-compilation — L134]$ (line 134, col 1, score 0.97)
- $[docs/unique/template-based-compilation#L134|template-based-compilation — L134]$ (line 134, col 3, score 0.97)
- $[cross-language-runtime-polymorphism#L218|Cross-Language Runtime Polymorphism — L218]$ (line 218, col 1, score 0.97)
- $[cross-language-runtime-polymorphism#L218|Cross-Language Runtime Polymorphism — L218]$ (line 218, col 3, score 0.97)
- $[cross-target-macro-system-in-sibilant#L195|Cross-Target Macro System in Sibilant — L195]$ (line 195, col 1, score 0.97)
- $[cross-target-macro-system-in-sibilant#L195|Cross-Target Macro System in Sibilant — L195]$ (line 195, col 3, score 0.97)
- $[cross-target-macro-system-in-sibilant#L187|Cross-Target Macro System in Sibilant — L187]$ (line 187, col 1, score 1)
- $[cross-target-macro-system-in-sibilant#L187|Cross-Target Macro System in Sibilant — L187]$ (line 187, col 3, score 1)
- $[cross-target-macro-system-in-sibilant#L185|Cross-Target Macro System in Sibilant — L185]$ (line 185, col 1, score 0.99)
- $[cross-target-macro-system-in-sibilant#L185|Cross-Target Macro System in Sibilant — L185]$ (line 185, col 3, score 0.99)
...
- [ParticleSimulationWithCanvasAndFFmpeg — L260](particlesimulationwithcanvasandffmpeg.md#L260) (line 260, col 1, score 0.99)
- [ParticleSimulationWithCanvasAndFFmpeg — L260](particlesimulationwithcanvasandffmpeg.md#L260) (line 260, col 3, score 0.99)
- $[sibilant-macro-targets#L184|sibilant-macro-targets — L184]$ (line 184, col 1, score 1)
- $[sibilant-macro-targets#L184|sibilant-macro-targets — L184]$ (line 184, col 3, score 1)
...
- $[polyglot-repl-interface-layer#L168|polyglot-repl-interface-layer — L168]$ (line 168, col 1, score 1)
- $[polyglot-repl-interface-layer#L168|polyglot-repl-interface-layer — L168]$ (line 168, col 3, score 1)
...
- $[sibilant-metacompiler-overview#L104|sibilant-metacompiler-overview — L104]$ (line 104, col 1, score 1)
- $[sibilant-metacompiler-overview#L104|sibilant-metacompiler-overview — L104]$ (line 104, col 3, score 1)
- $[cross-target-macro-system-in-sibilant#L191|Cross-Target Macro System in Sibilant — L191]$ (line 191, col 1, score 1)
- $[cross-target-macro-system-in-sibilant#L191|Cross-Target Macro System in Sibilant — L191]$ (line 191, col 3, score 1)
- $[docs/unique/template-based-compilation#L133|template-based-compilation — L133]$ (line 133, col 1, score 1)
- $[docs/unique/template-based-compilation#L133|template-based-compilation — L133]$ (line 133, col 3, score 1)
