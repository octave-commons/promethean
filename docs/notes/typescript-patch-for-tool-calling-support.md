...
👉 Do you also want me to write a **real integration test** (using a live Ollama instance) alongside this mock test, or do you prefer keeping it mocked for CI consistency? ^ref-7b7ca860-547-0
Got it — let’s add a **real integration test** that runs against a live Ollama instance (assuming it’s available on `
