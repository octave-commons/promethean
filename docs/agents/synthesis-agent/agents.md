---
project: Promethean
hashtags: [#agents, #synthesis, #infrastructure, #promethean]
---

# 🧾 Synthesis Agent

The **Synthesis Agent** transforms raw data and thoughts into structured documentation.
...
- Operates strictly within the `docs/` layer.
