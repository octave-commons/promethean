---
uuid: 13bef474-93a4-4ac9-aa8a-2af571aa72a4
created_at: '2025-09-05T12:02:57Z'
filename: Emacs Config Diff Automation
title: Emacs Config Diff Automation
description: >-
  Automates diffing and merging config files in Emacs using deterministic rules
  and LLM fallback. Handles JSON, YAML, and other structured formats with schema
