---
uuid: 54a90f46-929d-4812-bf67-df2283156794
...
description: >-
  This guide explains how to implement a clean architecture using ports and
  adapters for persistence layers, focusing on testability and avoiding test
  hooks. It defines minimal interfaces (ports), provides adapter implementations
  for MongoDB and Chroma, and demonstrates a composition root for production
  wiring. The approach ensures business logic remains pure by injecting
  dependencies at the module boundary without touching test code.
tags:
  - ports
  - adapters
  - test-driven
...
test("ingest against real Mongo + Chroma", async t => {
  ...
  await mongo.connect();
  const chroma = new ChromaClient({ path: `http://${chromaC.getHost()}:${chromaC.getMappedPort(8000)}` });
...
[1]: https://betterprogramming.pub/how-to-ports-and-adapter-with-typescript-32a50a0fc9eb?utm_source=chatgpt.com "Ports and Adapter with Typescript | Carlos Cunha"
[2]: https://8thlight.com/insights/thats-not-yours?utm_source=chatgpt.com "That's Not Yours"
[3]: https://hynek.me/articles/what-to-mock-in-5-mins/?utm_source=chatgpt.com "“Don't Mock What You Don't Own” in 5 Minutes"
[4]: https://cookbook.chromadb.dev/core/clients/?utm_source=chatgpt.com "Chroma Clients"
[5]: https://www.npmjs.com/package/esmock?utm_source=chatgpt.com "esmock"
[6]: https://www.skypack.dev/view/esmock?utm_source=chatgpt.com "npm:esmock"
[7]: https://node.testcontainers.org/modules/mongodb/?utm_source=chatgpt.com "MongoDB - Testcontainers for NodeJS"
[8]: https://testcontainers.com/guides/getting-started-with-testcontainers-for-nodejs/?utm_source=chatgpt.com "Getting started with Testcontainers for Node.js"
