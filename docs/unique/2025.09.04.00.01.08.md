@promethean/docoops/02-embed seems to hang... I'm not sure what is goin on since the ollama server is definately getting hit the entire time.
I don't think there are any documents that are *that* big... Something fishy is going on.

It wouldn't hurt to memoize the embeddings. There were aparently a lot of identical hits.
