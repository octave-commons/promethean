...
created_at: openapi-validation-report.md
filename: OpenAPI Validation Report
title: OpenAPI Validation Report
description: >-
  This report highlights missing operationId fields in multiple OpenAPI
  endpoints that were skipped during validation. Each skipped endpoint lacks a
  required operationId, which is critical for proper API documentation and
  tooling integration. The report lists all affected paths and methods for
...
references:
  ...
  - uuid: 2792d448-c3b5-4050-93dd-93768529d99c
    ...
    score: 1
---
In path /grep, method post is missing operationId; skipping ^ref-5c152b08-1-0
