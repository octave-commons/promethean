---
uuid: 588332f0-6951-45a8-b369-5d7a9098ca7a
created_at: 2025.09.02.16.34.55.md
filename: level-cache
description: >-
  A minimal, functional-style embedded cache with TTL, namespaces, and pure
  helpers for reliable data storage. It wraps LevelDB with time-to-live (TTL)
  management, key namespaces, and no background daemons. Designed for simplicity
