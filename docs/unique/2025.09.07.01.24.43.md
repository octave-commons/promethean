...
```json
{
  ...
  "type":"object",
  "properties":{
    "eslint": {"type":"object","properties":{"errors":{"type":"integer"},"warnings":{"type":"integer"}},"required":["errors","warnings"]},
    "tests": {"type":"object","properties":{"passed":{"type":"integer"},"failed":{"type":"integer"}},"required":["passed","failed"]},
    "build": {"type":"boolean"},
    "sonar": {"type":"object","properties":{"qualityGate":"string","newCodeIssues":{"type":"integer"}}}
  },
  "required":["eslint","tests","build"],
  "additionalProperties": false
}
```
