...
description: >-
  A system to enforce strict changes in monorepos by defining sacred files that
  PRs cannot modify without explicit override. Uses a workflow that checks PRs
  against the `main` branch's rules to prevent accidental changes to critical
  configuration files.
tags:
  - monorepo
  - PR guards
  - constitution
related_to_uuid:
  - 271bf7f7-c546-431e-8f81-357e7c0120b8
...
related_to_title:
  ...
  - run-step-api
references:
  - uuid: 271bf7f7-c546-431e-8f81-357e7c0120b8
    line: 76
    col: 0
    score: 1
