---
uuid: 7c62f921-e1eb-46d4-8652-1f716b64d429
created_at: '2025-09-19T23:23:12Z'
title: 2025.09.19.23.23.12
filename: Kanban FSM with Safe Cycles
description: >-
  A refined Kanban state machine that includes explicit reverse paths for safe
  backtracking and session-end hand-offs without requiring pull requests. The
  system allows procedural cycles for honest backtracking when work is misshaped
  or new information emerges, ensuring no fake forward progress. It also
  provides a safe transition path for cloud agents to handle session endings
  without PRs.
tags:
  - Kanban
  - state machine
