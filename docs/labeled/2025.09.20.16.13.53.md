---
uuid: 583f9aac-72ba-4b37-87e3-f8ebb7c1770a
created_at: '2025-09-20T16:13:53Z'
title: 2025.09.20.16.13.53
filename: HTTP Transport Patch for MCP Server
description: >-
  A patch to fix GitHub connector JSON body issues and wire HTTP transport to
  MCP server. Provides a clean HTTP API for tool invocation and server health
  checks.
tags:
  - mcp
  - http
