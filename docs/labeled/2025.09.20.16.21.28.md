---
uuid: 30a1d63b-8230-4397-9143-59164c191535
...
description: >-
  ...
  with stateless per-request handling and proper adapter connection. The change
  ensures HTTP MCP works without re-architecting the server.
tags:
  - mcp
  - fastify
  - http
