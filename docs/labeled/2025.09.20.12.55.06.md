---
uuid: e21d5de8-6bf8-4328-ac74-a3ae1b2e8e6b
created_at: '2025-09-20T12:55:06Z'
title: 2025.09.20.12.55.06
filename: Pair Programming MCP
description: >-
  Defines the MCP's workflow for pair programming, including solo programming,
  code review, and driver/navigator modes. The system uses additive operations
  only, with destructive operations strictly forbidden. It provides tools for
  interacting with the workspace and sandbox environments.
tags:
  - pair programming
  - MCP
  - workflow
