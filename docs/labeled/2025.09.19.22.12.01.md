---
uuid: f0ea1055-6d0c-4842-aa57-dc63fab94d1a
...
description: >-
  ...
  kernel for process management. Defines states, transitions, and procedural
  rules without timeboxing or special phases. Ensures tasks drive board
  generation and enforces single-source status.
tags:
  - Kanban
  - FSM
  - process
