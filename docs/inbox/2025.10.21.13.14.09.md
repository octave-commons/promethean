...
```json
{
  ...
  "scripts": {
    ...
    "duck:web": "pnpm --filter @promethean/duck-web-frontend dev",
    "duck:gateway": "pnpm --filter @promethean/enso-browser-gateway dev",
    ...
    "postinstall": "pnpm --filter @promethean/embedding^... run build && pnpm --filter @promethean/piper^... run build && pnpm --filter @promethean/piper run build && pnpm --filter @promethean/promethean-cli run build",
    ...
    "gen:ecosystem": "pnpm --filter @promethean/shadow-conf build && pnpm exec shadow-conf ecosystem --input-dir ./system/daemons --out .",
    ...
    "nx": "nx",
    "shadow:build": "pnpm --filter @promethean/shadow-ui run build && pnpm --filter '@promethean/*-frontend' run build:shadow",
    "shadow:watch": "pnpm --filter @promethean/shadow-ui run watch",
    "shadow:watch:frontends": "pnpm --parallel --filter '@promethean/*-frontend' run watch:shadow",
  ...
  "dependencies": {
    ...
    "@promethean/piper-frontend": "workspace:*",
    "@promethean/pm2-helpers": "workspace:*",
    "@promethean/report-forge-frontend": "workspace:*",
...
```json
{
  ...
  "dependencies": {
    "@promethean/lmdb-cache": "workspace:*",
    "@promethean/markdown": "workspace:*",
    "@promethean/utils": "workspace:*",
    "@promethean/agents-workflow": "workspace:*",
    "chokidar": "^4.0.1",
    "globby": "^14.0.2",
    "gray-matter": "^4.0.3",
    "mongodb": "^6.18.0",
