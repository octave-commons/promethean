...
- **Obsidian wikilinks** (`[file-name](file-name.md)`) don't render well on GitHub
...
- ✅ **Automatic wikilink conversion** - `[file](file.md)` → `[file](file.md)` for GitHub
...
### **Wikilink Conversion**
```
Obsidian: [Display Text](Display%20Text.md)
GitHub:   [Display Text](file-name.md)

Obsidian: [folder/file](folder/file.md)
GitHub:   [folder/file](folder/file.md)

Obsidian: [file-name](file-name.md)
