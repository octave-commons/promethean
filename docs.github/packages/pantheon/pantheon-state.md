...
- [pantheon-core](pantheon-core.md) - Core actor model and context engine
- [pantheon-persistence](pantheon-persistence.md) - Conversation context management
- [pantheon-protocol](pantheon-protocol.md) - Message transport and serialization
