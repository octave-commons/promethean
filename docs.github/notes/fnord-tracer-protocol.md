...
4. **Inline Tags** (visible): `[T:fnord](T:fnord.md)`, `[T:mirror:low](T:mirror:low.md)`, `[T:mythic:7](T:mythic:7.md)`.
...
- **Injection (explicit):**
    ...
    > [T:fnord](T:fnord.md) We’ll leave a tracer in this turn and watch the field shift.
