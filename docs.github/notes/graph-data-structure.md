---
```
uuid: 64d60176-5d81-45c2-b20a-705b5f9e855c
```
```
created_at: graph-ds.md
```
filename: Graph Data Structure
title: Graph Data Structure
```
description: >-
```
  A reusable, generic graph implementation with BFS/DFS, Dijkstra, A*,
  topological sorting, connected components, and more. Supports
  directed/undirected graphs, per-node/edge metadata, and optional weights.
...
references:
  ...
  - uuid: 86a691ec-ca1f-4350-824c-0ded1f8ebe70
    ...
    col: 0
    score: 1
  - uuid: 21913df0-a1c6-4ba0-a9e9-8ffc35a71d74
    line: 5
    col: 0
    score: 1
...
export class Graph<ND = unknown, ED = unknown> {
  ...
  *edges(): IterableIterator<EdgeRecord<ED>> {
  ...
  bfs(start: Id, stop?: (id: Id) => boolean): { parent: Map<Id, Id | null>, order: Id[] } {
    ...
    const q: Id[] = [start];
    const parent = new Map<Id, Id | null>([start, null](start,%20null.md));
    const order: Id[] = [];
    while (q.length) {
      const u = q.shift()!;
      order.push(u);
...
* `bfs/dfs`: **OV+E** ^ref-6620e2f2-358-0
...
```
Want add-ons Louvain community detection, MST, bipartite checks, or a persistent/immutable version? Say the word and I’ll bolt them on.
 ^ref-6620e2f2-394-0 ^ref-6620e2f2-412-0 ^ref-6620e2f2-423-0 ^ref-6620e2f2-446-0 ^ref-6620e2f2-465-0 ^ref-6620e2f2-467-0 ^ref-6620e2f2-478-0 ^ref-6620e2f2-480-0 ^ref-6620e2f2-494-0 ^ref-6620e2f2-495-0 ^ref-6620e2f2-527-0 ^ref-6620e2f2-602-0 ^ref-6620e2f2-996-0 ^ref-6620e2f2-1960-0 ^ref-6620e2f2-2070-0 ^ref-6620e2f2-2310-0 ^ref-6620e2f2-3994-0
...
- [Graph Data Structure — L5]graph-ds.md#^ref-21913df0-5-0 (line 5, col 0, score 1)
...
- [Obsidian ChatGPT Plugin Integration — L61]obsidian-chatgpt-plugin-integration.md#^ref-ca8e1399-61-0 (line 61, col 0, score 1)
