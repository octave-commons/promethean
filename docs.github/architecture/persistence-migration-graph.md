...
```mermaid
graph TD
    KanbanBoard[kanban](docs/agile/boards/kanban.md) --> TaskFile[Agent Tasks Persistence Migration to DualStore](docs/agile/tasks/Agent%20Tasks%20Persistence%20Migration%20to%20DualStore.md)

    TaskFile --> Checklist[persistence-migration-checklist](docs/reports/persistence-migration-checklist.md)
    TaskFile --> DependencyGraph[persistence-dependency-graph](docs/reports/persistence-dependency-graph.md)
