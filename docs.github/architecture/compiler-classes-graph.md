...
```mermaid
graph TD
    KanbanBoard[kanban](docs/agile/boards/kanban.md) --> TaskFile[implement classes in compiler lisp incoming](docs/agile/tasks/implement%20classes%20in%20compiler%20lisp%20incoming.md)
    TaskFile --> Checklist[compiler-classes-checklist](docs/reports/compiler-classes-checklist.md)
    TaskFile --> DependencyGraph[compiler-classes-dependency-graph](docs/reports/compiler-classes-dependency-graph.md)
