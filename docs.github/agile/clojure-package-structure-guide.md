...
(def cli-options
  ["-p" "--port PORT" "Port number"
    :default 3000
    :parse-fn](%22-p%22%20%22--port%20PORT%22%20%22Port%20number%22%0A%20%20%20%20:default%203000%0A%20%20%20%20:parse-fn.md)
   ["-h" "--help" "Show help"]])
...
```clojure
{:source-paths ["src"]
 :dependencies [org.clojure/clojurescript "1.11.60"](org.clojure/clojurescript%20%221.11.60%22.md)
 :builds
