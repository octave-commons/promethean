...
- [PACKAGE_CONSOLIDATION_PLAN_STORY_POINTS](PACKAGE_CONSOLIDATION_PLAN_STORY_POINTS.md)
- [clojure-package-structure-guide](docs/agile/clojure-package-structure-guide.md)
