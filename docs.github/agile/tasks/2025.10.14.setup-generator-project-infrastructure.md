...
```clojure
;; .cljfmt.edn
{:indents {defprotocol [:inner 0](:inner%200.md)
           defrecord [:inner 0](:inner%200.md)
           deftype [:inner 0](:inner%200.md)
           defmethod [:inner 0](:inner%200.md)
           letfn [:inner 0](:inner%200.md)}}
```
