...
- [PACKAGE_CONSOLIDATION_PLAN_STORY_POINTS](PACKAGE_CONSOLIDATION_PLAN_STORY_POINTS.md) - Original consolidation plan
- [kanban-cli-reference](docs/agile/kanban-cli-reference.md) - Kanban management commands
- [process](docs/agile/process.md) - Development process guidelines
