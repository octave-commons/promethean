...
- Open the [kanban](../agents/instructions/kanban.md) board file.
...
If there appear to be multiple tasks related to your task, create a new task, mention the related tasks, add [wikilinks](wikilinks.md) to them from the task you created, and safely append to the related tasks a [wikilink](wikilink.md) pointing to the task you just created.
