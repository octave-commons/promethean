...
put new docs into [docs/inbox](docs/inbox.md) if you don't know where else to put it.
...
- [OPENCODE_CONFIGURATION_MASTER](OPENCODE_CONFIGURATION_MASTER.md)
- [opencode-configuration-guide](opencode-configuration-guide.md)
- [opencode_tools](opencode_tools.md)
