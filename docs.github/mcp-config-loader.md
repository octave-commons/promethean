...
- [MCP_AUTHORIZATION_ARCHITECTURE](MCP_AUTHORIZATION_ARCHITECTURE.md) - Security and authorization design
- [README](packages/mcp/README.md) - MCP package overview and usage
- [mcp-reference](docs/agile/mcp-reference.md) - MCP development reference
- [kanban-cli-reference](docs/agile/kanban-cli-reference.md) - CLI tooling reference
