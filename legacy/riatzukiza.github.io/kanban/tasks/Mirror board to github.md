Are there obsidian plugins that could create git [[project.md]] boards from the obsidian kanban?
...
- Changes to the [[board.md]] get reflected to a github [[project.md]] [[board.md]] on push to a specific branch
- Changes to the [[project.md]] [[board.md]] on github get reflected onto the obsidian [[board.md]] and pushed to a specific branch
