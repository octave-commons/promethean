...
I have some [[Colors.md]] I want to use, mainly from the monokai theme. I will continue to look for more of the [[Colors.md]], for example from obsidians monokai, but for now it's working.
