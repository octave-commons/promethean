...
The progress on the project is tracked using a kanban [[board.md]] with the following sections and procedure
...
Work that has been sufficiently refined and is considered [[ready.md]] to be worked on.
...
Work that is pending review before being consdiered actually [[done.md]].
