...
| `/` | `x` | in progress, or half-[[done.md]] | `IN_PROGRESS` | Duplicate symbol '`/`': this status will be ignored. |
...
| `x` | `space` | [[done.md]] | `[[[[done]]]]` | Duplicate symbol '`x`': this status will be ignored. |
...
| `/` | `x` | Half [[done.md]] | `IN_PROGRESS` | Duplicate symbol '`/`': this status will be ignored. |
...
| `k` | `x` | Key | `TODO` |  |
| `w` | `x` | Win | `TODO` |  |
| `space` | `x` | [[to-do.md]] | `TODO` | Duplicate symbol '`space`': this status will be ignored. |
