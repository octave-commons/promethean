...
| ---------------- | ---------------------------------------------------- | -------------------------------------------------------------- |
| `stt-input`      | Audio frames sent to STT service.                    | [[stt-ws-request-v1.json|`stt-ws-request-v1.json`]] |
| `stt-output`     | Transcription emitted by STT service.                | [[stt-ws-response-v1.json|`stt-ws-response-v1.json`]] |
