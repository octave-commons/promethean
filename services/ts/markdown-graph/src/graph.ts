...
import {
  ContextStore,
  DualStoreManager,
} from "@shared/ts/dist/persistence/index.js";
...
export class GraphDB {
  ...
  private readonly links: DualStoreManager<"text", "timestamp">;
  private readonly hashtags: DualStoreManager<"text", "timestamp">;
