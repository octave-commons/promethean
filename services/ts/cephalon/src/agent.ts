...
import { CircularWaveForm } from './desktop-audio-render-loop';
...
export class AIAgent extends EventEmitter {
    ...
    async generateResponse({
        ...
        const imageBuffer = await annotateImage(await captureScreen(), getCurrentDateTime(), "Desktop Capture");
...
`,
    ...
    wavRecorder= new CircularWaveForm()
    async start() {
