...
import { makeDiscordVoiceAdapter, type VoiceAdapter } from '../factories/voice.js';
...
export async function buildLeaveVoiceScope(ctx?: { bot?: Bot }): Promise<LeaveVoiceScope> {
    ...
    const voice = ctx?.bot
        ? makeDiscordVoiceAdapter({
              ...
              getVoiceStateHandler: (): VoiceStateChangeHandler | undefined => ctx.bot!.voiceStateHandler,
