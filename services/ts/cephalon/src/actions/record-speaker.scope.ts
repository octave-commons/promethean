...
export async function buildRecordSpeakerScope(): Promise<Pick<RecordSpeakerScope, 'logger' | 'policy'>> {
    return {
...
export function makeRecordActions(): Pick<RecordSpeakerScope, 'start' | 'stop'> {
    return {
