...
export function makeDiscordVoiceAdapter(params: {
    ...
    const { client, getCurrentVoiceSession, setCurrentVoiceSession, getVoiceStateHandler, setVoiceStateHandler } =
        params;
    ...
    return {
        async leaveGuild(_guildId: string) {
            ...
            const guard: VoiceStateChangeHandler = (_1: discord.VoiceState, _2: discord.VoiceState) => {
