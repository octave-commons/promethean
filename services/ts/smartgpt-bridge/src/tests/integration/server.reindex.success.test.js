...
var CollectingCollection = /** @class */ (function () {
  function CollectingCollection() {
    this.calls = 0;
  }
  CollectingCollection.prototype.upsert = function () {
...
(0, ava_1.default)(
  "POST /v0/reindex returns 200 with stubbed chroma",
  function (t) {
