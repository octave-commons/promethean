...
(0, ava_1.default)(
  "GET /openapi.json includes servers, schemas, and paths",
  function (t) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            prev = process.env.PUBLIC_BASE_URL;
                  ...
                  return __generator(this, function (_e) {
                    switch (_e.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          req.get("/openapi.json").expect(200),
                        ];
                      case 1:
                        res = _e.sent();
                        ...
                        t.truthy(
                          (_b =
                            (_a = res.body.components) === null || _a === void 0
                              ? void 0
                              : _a.schemas) === null || _b === void 0
                            ? void 0
                            : _b.GrepRequest,
                        );
                        t.true(Array.isArray(res.body.servers));
                        t.is(
                          res.body.servers[0].url,
                          process.env.PUBLIC_BASE_URL,
                        );
                        t.truthy(
                          (_d =
                            (_c = res.body.paths) === null || _c === void 0
                              ? void 0
                              : _c["/v0/grep"]) === null || _d === void 0
                            ? void 0
                            : _d.post,
                        );
                        return [2 /*return*/];
