...
function countOperations(paths) {
  return Object.values(paths).reduce(function (sum, item) {
    return sum + Object.keys(item).length;
  }, 0);
}
(0, ava_1.default)(
  "GET /v1/openapi.json exposes no more than 30 ops",
  function (t) {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          req.get("/v1/openapi.json").expect(200),
                        ];
                      case 1:
                        res = _a.sent();
                        ops = countOperations(res.body.paths || {});
                        t.true(ops <= 30);
                        return [2 /*return*/];
                    }
                  });
