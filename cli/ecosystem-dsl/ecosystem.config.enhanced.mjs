 ...
 * Generated at: Sun Nov 16 20:29:40 CST 2025
 * Mode: aggregate
 *
 * Features:
...
const generatedApps = {
  "apps": [
    ...
    },
    {
      ...
      "args": [
        "node_modules\/nx\/src\/daemon\/server\/start.js"
      ],
      "pidFile": "logs\/nx-daemon.pid",
      "watch": false,
      "cwd": ".",
      "name": "nx-daemon",
      "script": "node",
      ...
      "mergeLogs": true,
      "maxRestarts": 10,
      "outFile": "logs\/nx-daemon-out.log",
      "maxMemoryRestart": "1G",
      "logDateFormat": "YYYY-MM-DD HH:mm:ss Z",
      "instances": 1,
      "errorFile": "logs\/nx-daemon-err.log",
      "restartDelay": 5000,
      "logFile": "logs\/nx-daemon-combined.log"
    },
    {
      "killTimeout": 15000,
      "exec_mode": "fork",
    ...
    },
    {
      ...
      "args": [
        "scripts\/nx-watcher.mjs",
        "--operations",
        "build,test,lint,typecheck,coverage"
      ],
      "pidFile": "logs\/nx-watcher.pid",
      "watch": false,
      "cwd": ".",
...
console.log(`Total processes configured: 14`);
