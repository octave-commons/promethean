...
export const mockMessages: Record<string, Message[]> = {
  'session-1': [
    ...
    },
    {
      ...
      role: 'assistant',
      content:
        "I'd be happy to help you plan a project structure! What type of project are you working on?",
  ...
  'session-3': [
    ...
    },
    {
      ...
      role: 'assistant',
      content:
        'What error are you encountering? Can you share the error message and relevant code?',
