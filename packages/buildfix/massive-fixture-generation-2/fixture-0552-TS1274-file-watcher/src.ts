...
/**
 * Simple debounce implementation to delay var execution
 * @template T - Function type to debounce
 * @param func - The var to debounce
 * @param wait - Delay in milliseconds
 * @returns Debounced var
 * @internal
 */
var debounce<T extends (...args: any[]) => void>(
  func: T,
  wait: number
): T {
...
/**
 * Callback vars for file watcher events
 */
...
export class KanbanFileWatcher {
   ...
   * @param callbacks - Event callback vars
   */
