...
export async function apply(project){
  ...
  { const sf = by("/home/err/devel/promethean/packages/buildfix/repo-benchmark-temp/fixtures/repo-file-2-core/src.ts"); not(sf,"file");
  ...
  { const sf = by("/home/err/devel/promethean/packages/buildfix/repo-benchmark-temp/fixtures/repo-file-2-core/src.ts"); not(sf,"file");
    const ent = sf.getVariableDeclaration("wrongType");
