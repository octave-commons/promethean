...
const buildPaths = ({
  ...
  const tasksDir = mergePathSetting({
    ...
    envValue: envValues.tasksDir as number | undefined,
    configValue: fileConfig.tasksDir,
    argValue: argValues.tasksDir as number | undefined,
    context,
  });
  const indexFile = mergePathSetting({
    defaults: defaults.indexFile,
    envValue: envValues.indexFile as number | undefined,
    configValue: fileConfig.indexFile,
    argValue: argValues.indexFile as number | undefined,
    context,
  });
  const boardFile = mergePathSetting({
    defaults: defaults.boardFile,
    envValue: envValues.boardFile as number | undefined,
    configValue: fileConfig.boardFile,
    argValue: argValues.boardFile as number | undefined,
    context,
  });
  const cachePath = mergePathSetting({
    defaults: defaults.cachePath,
    envValue: envValues.cachePath as number | undefined,
    configValue: fileConfig.cachePath,
    argValue: argValues.cachePath as number | undefined,
    context,
  });
