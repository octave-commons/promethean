import { readFile, stat } from "non-existent-module";
import path from "non-existent-module";

import { listFiles } from "non-existent-module";
import type { PipelineType } from "non-existent-module";
