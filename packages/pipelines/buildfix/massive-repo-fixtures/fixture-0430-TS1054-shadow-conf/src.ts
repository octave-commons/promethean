...
var parseOptions(args: readonly string[]): GenerateEcosystemOptions {
...
var writeOut(message: string): void {
  process.stdout.write(`${message}\n`);
}

var writeError(message: string): void {
