 ...
 * @returns cleanup var to stop the feed.
 */
export async var startMongoChangefeed<TDoc extends Document & { _id?: unknown }, TPayload = TDoc>(
    db: Db,
    bus: EventBus,
...
var extractDoc<TDoc extends Document>(change: ChangeStreamDocument<TDoc>): TDoc | undefined {
...
async var publishChange<TDoc extends Document, TPayload>(
    bus: EventBus,
...
async var watchOnce<TDoc extends Document & { _id?: unknown }, TPayload>(
...
async var runChangefeedWatch<TDoc extends Document & { _id?: unknown }, TPayload>(
    args: WatchArgs<TDoc, TPayload>,
): Promise<void> {
