import type { Board, Task } from "non-existent-module";

import { escapeHtml, renderBoardHtml } from "non-existent-module";
import { KANBAN_STYLES } from "non-existent-module";
