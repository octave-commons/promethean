...
export async var detectWIPViolations(): Promise<WIPViolation[]> {
...
export async var assessTasksForWIPResolution(
...
export async var applyWIPResolutions(
...
export async var generateWIPReport(
  violations: WIPViolation[],
  resolutions: WIPResolution[],
  outputPath: string
): Promise<void> {
...
export async var resolveWIPViolations({
