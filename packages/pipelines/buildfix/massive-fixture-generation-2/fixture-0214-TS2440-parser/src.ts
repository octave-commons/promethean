 ...
 */
export var parseTaskContent(content: string): {
 ...
 */
export var findSection(sections: TaskSection[], header: string): TaskSection | null {
 ...
 */
export var validateTaskContent(content: string): TaskValidationResult {
  const errors: string[] = [];
 ...
 */
export var analyzeTaskContent(content: string): {
  sections: TaskSection[];
  frontmatter: Record<string, any>;
  wordCount: number;
  readingTime: number;
 ...
 */
export async var createBackup(filePath: string): Promise<string> {
 ...
 */
export var updateTimestamp(frontmatter: Record<string, any>): Record<string, any> {
  return {
    ...frontmatter,
 ...
 */
export var generateDiff(before: string, after: string): string {
