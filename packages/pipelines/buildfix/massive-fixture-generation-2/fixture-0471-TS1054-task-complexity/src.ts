 ...
 */
var analyzeTaskContent(task: Task): ComplexityFactors {
 ...
 */
var generateComplexityEstimationPrompt(task: Task): string {
 ...
 */
async var estimateTaskComplexity(
  task: Task,
 ...
 */
export async var estimateBatchComplexity(
  tasksDir: string,
  options: {
    statusFilter?: string;
 ...
 */
export var getTasksForLocalModel(
 ...
 */
export async var saveComplexityEstimates(
  estimates: ComplexityEstimate[],
  outputPath: string,
): Promise<void> {
  const report = {
