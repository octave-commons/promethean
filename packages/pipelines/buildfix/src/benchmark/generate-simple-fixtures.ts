...
x();`,
  ...
  {
    filename: 'ts7005-type-mismatch.ts',
...
async function generateFixtures() {
  ...
  console.log('🚀 Creating TypeScript error fixtures...');
  ...
  for (const fixture of ERROR_FIXTURES) {
    ...
    console.log(`✅ Created: ${fixture.filename} (expected: ${fixture.expectedError})`);
  }

  console.log(`\n📊 Generated ${ERROR_FIXTURES.length} TypeScript error fixtures`);
  console.log('🎯 Ready for benchmark testing!');
}
