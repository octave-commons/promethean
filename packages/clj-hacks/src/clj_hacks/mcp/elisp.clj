...
(defn- value->ast [v]
  (cond
    ...
    (boolean? v) (if v (ast/el-symbol "t") nil)
    (sequential? v) (apply ast/el-list (map value->ast v))
    (number? v) v
    (nil? v) nil
...
(defn mcp-block-ast [servers]
  (ast/el-list (ast/el-symbol "with-eval-after-load")
            (ast/quote (ast/el-symbol "mcp"))
            (ast/el-list (ast/el-symbol "setq")
                      (ast/el-symbol "mcp-hub-servers")
