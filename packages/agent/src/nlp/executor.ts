...
export class AgentOSCommandExecutor implements CommandExecutor {
  ...
  private async executeStart(command: Command, context: ExecutionContext): Promise<any> {
  ...
  private async executeStop(command: Command, context: ExecutionContext): Promise<any> {
    const { target, parameters } = command;
  ...
  private async executeStatus(command: Command, context: ExecutionContext): Promise<any> {
    const { target, parameters } = command;
  ...
  private async executeConfigure(command: Command, context: ExecutionContext): Promise<any> {
    const { target, parameters } = command;
  ...
  private async executeCreate(command: Command, context: ExecutionContext): Promise<any> {
    const { target, parameters } = command;
  ...
  private async executeDelete(command: Command, context: ExecutionContext): Promise<any> {
    const { target, parameters } = command;
    
    // First stop, then delete
    await this.executeStop(command, context);
  ...
  private async executeUpdate(command: Command, context: ExecutionContext): Promise<any> {
    const { target, parameters } = command;
    
    // Update is similar to configure
    return await this.executeConfigure(command, context);
  }
  
  private async executeQuery(command: Command, context: ExecutionContext): Promise<any> {
    const { target, parameters } = command;
  ...
  private async executeHelp(command: Command, context: ExecutionContext): Promise<any> {
    const { target, parameters } = command;
    ...
    const helpContent = {
      ...
      configure: {
        ...
        examples: [
          'configure agent agent1 memory=512MB',
          'configure service monitoring interval=30s'
        ]
      },
      help: {
