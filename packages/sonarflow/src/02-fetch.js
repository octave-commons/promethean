...
var args = (0, utils_js_1.parseArgs)({
  "--project":
    (_a = process.env.SONAR_PROJECT_KEY) !== null && _a !== void 0 ? _a : "",
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          url = ""
            .concat(utils_js_1.SONAR_URL)
            .concat(pathname, "?")
            .concat(qs);
          return [
            4 /*yield*/,
            fetch(url, { headers: __assign({}, (0, utils_js_1.authHeader)()) }),
          ];
        case 1:
          res = _a.sent();
          if (!res.ok)
            throw new Error(
              "Sonar API ".concat(res.status, " ").concat(pathname),
            );
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            (0, utils_js_1.writeJSON)(args["--out"], payload),
          ];
        case 5:
          _b.sent();
          console.log(
            "sonarflow: fetched "
              .concat(issues.length, " issues for ")
              .concat(project, " \u2192 ")
              .concat(args["--out"]),
          );
          return [2 /*return*/];
