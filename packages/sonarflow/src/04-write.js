    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            fs_1.promises.readFile(path.resolve(args["--in"]), "utf-8"),
          ];
        case 1:
          ...
          return [
            4 /*yield*/,
            fs_1.promises.mkdir(path.resolve(args["--out"]), {
              recursive: true,
            }),
          ];
        case 2:
        ...
        case 3:
          ...
          body = __spreadArray(
            __spreadArray(
              ...
              t.acceptance.map(function (a) {
                return "- [ ] ".concat(a);
              }),
              true,
            ),
            ["", "## References", "", refsTable, "", END, ""],
            false,
          ).join("\n");
        ...
        case 4:
          existing = _e.sent();
          gm = existing
            ? (0, gray_matter_1.default)(existing)
            : { content: "", data: {} };
          preserved = stripGenerated(gm.content);
          final = gray_matter_1.default.stringify(
            (preserved ? preserved + "\n\n" : "") + body,
            __assign(__assign({}, gm.data), fm),
            { language: "yaml" },
          );
          return [
            4 /*yield*/,
            fs_1.promises.writeFile(outPath, final, "utf-8"),
          ];
        case 5:
          _e.sent();
          index.push(
        ...
        case 8:
          ...
          console.log(
            "sonarflow: wrote "
              .concat(tasks.length, " task files \u2192 ")
              .concat(args["--out"]),
          );
          return [2 /*return*/];
      }
...
function cryptoRandomUUID() {
  ...
  return (_c =
    (_b =
      (_a = globalThis.crypto) === null || _a === void 0
        ? void 0
        : _a.randomUUID) === null || _b === void 0
      ? void 0
