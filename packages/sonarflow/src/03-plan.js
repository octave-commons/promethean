  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          url = "".concat(
            (_a = process.env.OLLAMA_URL) !== null && _a !== void 0
              ? _a
        ...
        case 1:
          res = _b.sent();
          if (!res.ok) throw new Error("ollama ".concat(res.status));
...
function bundleKey(i, mode, depth) {
  var comp = i.component.includes(":")
    ? i.component.split(":")[1]
    : i.component;
  var pref = (0, utils_js_1.pathPrefix)(comp, depth);
  if (mode === "rule") return "rule:".concat(i.rule);
  if (mode === "prefix") return "prefix:".concat(pref);
  return "rule:".concat(i.rule, "|prefix:").concat(pref);
}
function bundleTitle(k) {
  var parts = k.split("|").map(function (p) {
    return p.replace(/^rule:/, "Rule ").replace(/^prefix:/, "Path ");
  });
  return parts.join(" • ");
}
function main() {
    ...
    return __generator(this, function (_p) {
      switch (_p.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            fetch("file://" + process.cwd() + "/" + args["--in"]),
          ];
        case 1:
          return [4 /*yield*/, _p.sent().text()];
        case 2:
          (_a = _c.apply(_b, [_p.sent()])),
            (issues = _a.issues),
            (project = _a.project);
          ...
          for (_i = 0, issues_1 = issues; _i < issues_1.length; _i++) {
            ...
            ((_h = groups.get(k)) !== null && _h !== void 0
              ? _h
              : groups.set(k, []).get(k)
            ).push(it_1);
          }
          ...
          _loop_1 = function (k, arr) {
            if (arr.length < min) return "continue";
            var sev = ["BLOCKER", "CRITICAL", "MAJOR", "MINOR", "INFO"].find(
              function (s) {
            ...
            bundles.push({
              ...
              rule: k.includes("rule:")
                ? (_j = k.split("|").find(function (x) {
                    return x.startsWith("rule:");
                  })) === null || _j === void 0
                  ? void 0
                  : _j.slice(5)
                : undefined,
              prefix: k.includes("prefix:")
                ? (_k = k.split("|").find(function (x) {
        ...
        case 3:
          ...
          user = [
            ...
            "BUNDLE: "
              .concat(b.title, "  (severity=")
              .concat(b.severityTop, ", types=")
              .concat(b.types.join(","), ")"),
        ...
        case 6:
          ...
          obj = {
            ...
            summary: "Address "
              .concat(b.issues.length, " SonarQube finding(s) related to ")
              .concat(
                (_l = b.rule) !== null && _l !== void 0
                  ? _l
                  : b.types.join("/"),
                ".",
              ),
            ...
            labels: Array.from(
              new Set(
                __spreadArray(
                  __spreadArray(
                    [],
                    (_o = obj.labels) !== null && _o !== void 0 ? _o : [],
                    true,
                  ),
                  ["sonarqube"],
                  false,
