...
const mockLLMGenerate = async (prompt, _format) => {
...
export class TaskAIManager {
    ...
    buildAnalysisPrompt(task, analysisType, context) {
...
Respond in JSON format.`;
    ...
    buildRewritePrompt(content, rewriteType, instructions, targetAudience, tone) {
...
- summary: Brief summary of changes made`;
    ...
    buildBreakdownPrompt(task, breakdownType, maxSubtasks, complexity, includeEstimates) {
