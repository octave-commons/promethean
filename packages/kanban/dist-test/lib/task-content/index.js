...
import { parseTaskContent, validateTaskContent, analyzeTaskContent } from './parser.js';
...
export class TaskContentManager {
     ...
     */
    async updateTaskSection(request) {
 ...
 */
export function createTaskLifecycleManager(contentManager, tasksDir, archiveDir) {
    return new TaskLifecycleManager(contentManager, tasksDir, archiveDir);
}
/**
 * Create a task content manager instance
 */
export function createTaskContentManager(tasksDir) {
