...
export type PatternCondition = {
    field: keyof Task | keyof ColumnData | 'task.title_similarity' | 'duplicate_count' | 'orphaned_event_count';
    operator: 'eq' | 'ne' | 'gt' | 'gte' | 'lt' | 'lte' | 'contains' | 'matches' | 'exists' | 'not-exists' | 'in' | 'not_in';
    value?: any;
    pattern?: RegExp;
    description?: string;
    type?: string;
...
//# sourceMappingURL=damage-pattern-dsl.d.ts.map