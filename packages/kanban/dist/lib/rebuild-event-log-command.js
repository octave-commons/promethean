 ...
 */
export const createRebuildEventLogCommand = (_boardFile, _tasksDir) => {
    const execute = async (args) => {
        ...
        console.log(`   Date range: ${stats.dateRange.earliest ? new Date(stats.dateRange.earliest).toLocaleDateString() : 'N/A'} to ${stats.dateRange.latest ? new Date(stats.dateRange.latest).toLocaleDateString() : 'N/A'}`);
        console.log('');
...
//# sourceMappingURL=rebuild-event-log-command.js.map