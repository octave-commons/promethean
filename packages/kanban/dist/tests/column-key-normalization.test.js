...
test('columnKey normalization consistency', (t) => {
    const testCases = [
...
test('columnKey handles edge cases', (t) => {
...
test('normalizeColumnName matches columnKey behavior', (t) => {
    ...
    const normalizeColumnName = engine.normalizeColumnName.bind(engine);
    const testCases = [
        'in_progress',
        'in-progress',
        'in progress',
    ...
    testCases.forEach((input) => {
        ...
        t.is(normalizeResult, columnKeyResult, `normalizeColumnName("${input}") should return "${columnKeyResult}", got "${normalizeResult}"`);
    });
});
//# sourceMappingURL=column-key-normalization.test.js.map