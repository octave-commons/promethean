...
import { getTaskSection, getTaskSections, updateTaskBody, updateTaskSection, } from '../lib/task-content/editor.js';
...
const createEditorTestContext = async () => {
    ...
    const cache = {
        readTask: async (uuid) => (uuid === task.uuid ? { ...task } : null),
        writeTask: async (updated) => {
            task = { ...task, ...updated };
        },
...
//# sourceMappingURL=task-content-editor.test.js.map