...
const getNormalizeColumnName = (engine) => {
    return engine.normalizeColumnName.bind(engine);
};
...
testCases.forEach((name) => {
    ...
    console.log(`${name.padEnd(11)} | ${boardKey.padEnd(16)} | ${transitionKey.padEnd(25)} | ${match}`);
});
console.log('\n🔧 Fix Analysis:');
...
//# sourceMappingURL=underscore-bug-demo.test.js.map