...
import type { FindCardsInput, FindCardsOutput, Card } from '../types/index.js';

export type FindCardsScope = {
    readonly normalizeName: typeof normalizeName;
};

export const findCards = (input: FindCardsInput, scope: FindCardsScope = { normalizeName }): FindCardsOutput => {
