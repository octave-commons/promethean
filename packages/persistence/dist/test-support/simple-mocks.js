 ...
 */
export function createMockIndexableContent(overrides = {}) {
    const baseMetadata = {
        type: 'file',
        source: 'filesystem',
 ...
 */
export function createMockIndexingStats(overrides = {}) {
    return {
        totalContent: 1000,
        contentByType: {
            file: 400,
 ...
 */
export function createMockIndexingOptions(overrides = {}) {
    return {
        skipVectors: false,
        skipMetadata: false,
        overwrite: false,
 ...
 */
export function createMockUnifiedIndexingConfig(overrides = {}) {
    return {
        vectorStore: {
            type: 'chromadb',
 ...
 */
export function isValidIndexableContent(obj) {
...
export function isValidSearchQuery(obj) {
    if (!obj || typeof obj !== 'object')
        return false;
    const query = obj;
    ...
    if (keys.length === 0)
        return false;
    return ((!query.query || typeof query.query === 'string') &&
...
export function isValidSearchResult(obj) {
    if (!obj || typeof obj !== 'object')
        return false;
    const result = obj;
    return (isValidIndexableContent(result.content) &&
        typeof result.score === 'number' &&
        (!result.highlights || Array.isArray(result.highlights)));
}
export function isValidSearchResponse(obj) {
    if (!obj || typeof obj !== 'object')
        return false;
    const response = obj;
    ...
    if (typeof response.took !== 'number')
        return false;
    if (!isValidSearchQuery(response.query))
        return false;
    ...
    if (!response.results.every(isValidSearchResult))
        return false;
    return true;
}
export function isValidIndexingStats(obj) {
    if (!obj || typeof obj !== 'object')
        return false;
    const stats = obj;
    const storageStats = stats.storageStats;
    return (typeof stats.totalContent === 'number' &&
...
//# sourceMappingURL=simple-mocks.js.map