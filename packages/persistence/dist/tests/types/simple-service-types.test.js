...
import { createMockIndexingStats, createMockIndexingOptions, createMockUnifiedIndexingConfig, isValidIndexingStats, } from '../../test-support/simple-mocks.js';
...
test('IndexingStats type structure validation', (t) => {
    ...
    for (const source of requiredSources) {
        t.true(typeof stats.contentBySource[source] === 'number', `Missing or invalid contentBySource.${String(source)}`);
    }
...
//# sourceMappingURL=simple-service-types.test.js.map