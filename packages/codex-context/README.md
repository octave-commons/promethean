...
<!-- READMEFLOW:BEGIN -->
# @promethean/codex-context

OpenAI-compatible context service bridging Codex to local LLMs with SmartGPT repo context.
...
```bash
pnpm -w add -D @promethean/codex-context
```
