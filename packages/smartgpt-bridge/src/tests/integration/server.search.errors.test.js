...
var ThrowingChroma = /** @class */ (function () {
  function ThrowingChroma() {}
  ThrowingChroma.prototype.getOrCreateCollection = function () {
  ...
  return ThrowingChroma;
})();
(0, ava_1.default)(
  "POST /v0/search 500 on chroma error; /v0/files/reindex 400 missing path",
  function (t) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            (0, indexer_js_1.setChromaClient)(new ThrowingChroma());
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          req.post("/v0/search").send({ q: "x" }).expect(500),
                        ];
                      case 1:
                        s = _a.sent();
                        t.false(s.body.ok);
                        return [
                          4 /*yield*/,
                          req.post("/v0/files/reindex").send({}).expect(400),
                        ];
                      case 2:
                        r = _a.sent();
                        t.false(r.body.ok);
                        return [
                          4 /*yield*/,
                          req.post("/v0/search").send({}).expect(400),
                        ];
                      case 3:
                        missingQ = _a.sent();
