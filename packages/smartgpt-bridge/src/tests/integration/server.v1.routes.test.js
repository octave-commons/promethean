...
(0, ava_1.default)("GET /v1/files/ returns flat file list", function (t) {
            ...
            (0, server_js_1.withServer)(ROOT, function (req) {
              return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/, req.get("/v1/files/").expect(200)];
                    case 1:
                      res = _a.sent();
                      t.true(res.body.ok);
...
(0, ava_1.default)(
  "GET /v1/files/?tree=true returns directory tree",
  function (t) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)(
  "GET /v1/files/readme.md returns file snippet",
  function (t) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
