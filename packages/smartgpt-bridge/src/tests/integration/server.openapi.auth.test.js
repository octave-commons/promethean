...
ava_1.default.serial(
  "openapi shows bearer security when auth enabled",
  function (t) {
                        ...
                        t.truthy(
                          (_b =
                            (_a = res.body.components) === null || _a === void 0
                              ? void 0
                              : _a.securitySchemes) === null || _b === void 0
                            ? void 0
                            : _b.bearerAuth,
                        );
...
ava_1.default.serial(
  "/auth/me requires valid token when enabled",
  function (t) {
    return __awaiter(void 0, void 0, void 0, function () {
      var prev;
      return __generator(this, function (_a) {
              ...
              (0, server_js_1.withServer)(ROOT, function (req) {
                return __awaiter(void 0, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [4 /*yield*/, req.get("/auth/me").expect(401)];
                      case 1:
                        _a.sent();
                        return [
                          4 /*yield*/,
