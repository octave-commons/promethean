...
function registerPolicyRoutes(app) {
    ...
    handler: function () {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, Policy_js_1.Policy.find().lean()];
            case 1:
              policies = _a.sent();
              return [2 /*return*/, { policies: policies }];
          }
        });
      });
    },
  ...
  app.post("/policies/create", {
    ...
    handler: function (req) {
      return __awaiter(_this, void 0, void 0, function () {
        var _a, role, action, resource, effect, policy;
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              policy = _b.sent();
              return [2 /*return*/, { ok: true, policy: policy }];
          }
        });
      });
    },
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              id = (req.body || {}).id;
              return [4 /*yield*/, Policy_js_1.Policy.findByIdAndDelete(id)];
            case 1:
              _a.sent();
