...
function up(db) {
  return __awaiter(this, void 0, void 0, function () {
    function upsert(role, action, resource, effect) {
      if (effect === void 0) {
        effect = "allow";
      }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            ...
            db
              .collection("policies")
              .createIndex(
                { role: 1, action: 1, resource: 1 },
                { unique: true },
              ),
          ];
        case 3:
          _a.sent();
          pol = db.collection("policies");
          return [
            4 /*yield*/,
            Promise.all([
              upsert("admin", "*", "*"),
        ...
        case 5:
          admin = _a.sent();
          if (!admin)
            throw new Error("Create admin user before running migration");
          return [
            4 /*yield*/,
            db
              .collection("users")
