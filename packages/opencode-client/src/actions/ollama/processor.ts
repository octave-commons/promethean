...
// Ollama job processing action

import { calculatePerformanceScore } from './performance.js';
import { callOllamaChat, callOllamaEmbed, callOllamaGenerate } from './api.js';
import { checkCache } from '../../actions/cache/check.js';
import { inferTaskCategory } from './inference.js';
import { Job } from './types.js';
import { now } from '@promethean/ollama-queue';
import { storeInCache } from '../../actions/cache/store.js';
