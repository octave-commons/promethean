...
/**
 * Enhanced Security Test for Path Traversal Vulnerability Fix
 * Tests various malicious payloads to ensure no bypass exists
 */

// Copy of the enhanced security functions from indexer.ts for testing
...
function containsSuspiciousPatterns(trimmed) {
...
const maliciousPayloads = [
  ...
  // Double encoding (PREVIOUSLY VULNERABLE)
  ...
  // Symlink attacks (PREVIOUSLY VULNERABLE)
  'symlink_to_etc',
  'link_to_etc',
  'mount_point',
  'device_link',
  ...
  // Reserved characters (PREVIOUSLY VULNERABLE)
...
console.log('🔒 Testing Enhanced Path Traversal Security Fixes\n');
