/**
 * @fileoverview Enhanced validation utilities and security validators
...
const GLOB_ATTACK_PATTERNS = [
  ...
  /\{\s*\.\./, // { .. with spaces
  /\.\.\s*\}/, // .. } with spaces
  // Enhanced patterns for remaining attack vectors
  /\.\.[\\/]/, // ../ or ..\ with any slash
  /[\\/]\.\.[\\/]/, // /../ or \..\ with any slash
  /\.\.[\\/]\.\./, // ../../ or ..\.. with any slash
  /%2e%2e%2f/i, // %2e%2e%2f (encoded ../)
  /%2e%2e%5c/i, // %2e%2e%5c (encoded ..\)
  /\.\.%2f/i, // ..%2f (mixed encoding)
  /\.\.%5c/i, // ..%5c (mixed encoding)
  /%2e%2e%2e%2f/i, // %2e%2e%2e%2f (encoded ../../)
  /%2e%2e%2e%5c/i, // %2e%2e%2e%5c (encoded ..\..)
  /\.\.\.\./, // .... (multiple dots)
  /\.\.\.\/\.\./, // ../../
  /\.\.\\\.\.\\\.\./, // ..\..\.. (Windows style)
];
 ...
 * Returns an object indicating type of threat detected
 */
...
function containsDangerousCharacters(trimmed: string): boolean {
  // Check for dangerous characters from array
...
/**
 * Enhanced Windows-specific path security validation
 */
function validateWindowsPathSecurity(trimmed: string): boolean {
  ...
  // Block exact Windows device names (standalone)
  if (WINDOWS_RESERVED_NAMES.includes(trimmed.toUpperCase())) {
    return false;
  }
...
/**
 * Detects glob pattern attacks with enhanced patterns
 */
